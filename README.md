...
*   **📲 NFC Tap-to-Pay**: Contactless SPW transfers via NFC — tap devices to send or receive tokens instantly. Available exclusively on NFC-capable devices.
